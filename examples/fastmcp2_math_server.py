"""
Example FastMCP 2.0 Math Server

This is an example FastMCP 2.0 server that provides mathematical operations.
It demonstrates how to create a FastMCP 2.0 server that can be integrated with LangGraph.

This uses the independent FastMCP 2.0 SDK (jlowin/fastmcp), not the
